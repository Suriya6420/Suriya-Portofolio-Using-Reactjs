...
const Data = () => {
  return (
    <div className="home__data">
        <h1 className="home__title">Suriyaprakash B J
        <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
        ...
        <p className="home__description">I'm a creative developer based in Madurai, and I'm very passionate and dedicated to my work.</p>
